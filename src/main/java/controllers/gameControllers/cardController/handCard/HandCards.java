...
public class HandCards {
    ...
    public void updateCurrentHandOverlay(Player player) {
        int x = getGameBackgroundController().getHandCardSpace().getHandCardSlots()[player.ordinal()].getX();
        int y = getGameBackgroundController().getHandCardSpace().getHandCardSlots()[player.ordinal()].getY();
        ...
        getScene().addObjectHigherThan(activeHandOverlay,
                getGameBackgroundController().getHandCardSpace().getHandCardSlots()[player.ordinal()]);
    }
    ...
    private void initializePositions() {
        Drawable[] handCardSlots = getGameBackgroundController().getHandCardSpace().getHandCardSlots();
        int cardSpread = 17;
        int relativeYPos = 2;
        for (int i = 0; i < PLAYER_NUMBER; i++) {
